...
def main():
    st.set_page_config(page_title="Czy przeżyłbyś tytanica?")
    ...
    data = np.array([pclass_radio,sex_radio,age_slider,sibsp_slider,parch_slider,fare_slider,embarked_radio]).reshape(1, -1)
